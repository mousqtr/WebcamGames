...
def init(base):
    ...
    print('Initialization of the Connect4.')

    base.background = OnscreenImage(parent=base.render2dp, image="tex/bedroom.jpg") # Load an image object
    base.cam2dp.node().getDisplayRegion(0).setSort(-20)

    # Load the table
    base.table = base.loader.loadModel("models/table")
    ...
    # Load the grid
    base.grid = base.loader.loadModel("models/grid")
    base.grid.reparentTo(base.render)
    base.blue_grid = base.loader.loadTexture("tex/blue_plastic.jpg")
    ...
    base.red_texture = base.loader.loadTexture("tex/red_plastic.jpg")
    base.yellow_texture = base.loader.loadTexture("tex/yellow_plastic.jpg")
    base.discs = []
    for i in range(0, 44):
        base.disc = base.loader.loadModel("models/disc")
    ...
    # Victory text
    font = base.loader.loadFont("font/Roboto-Medium.ttf")
